...
import { RegulatorAnalytics } from './types';
...
export default function App() {
  ...
  useEffect(() => {
    if (currentView !== 'regulator') return;
    ...
    loadData();
    // Re-fetches on every visit to the regulator tab, so activity from scans,
    // complaints and feedback submitted elsewhere shows up without a full
    // page reload.
  }, [currentView]);
