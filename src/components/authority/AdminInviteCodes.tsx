                ...
                {codes.map((c) => (
                  <tr key={c.id} className="border-b border-[#F0F3F8] last:border-0">
                    <td className="px-4 py-2.5">
                      <div className="font-semibold text-[#14224A]">{c.label || '—'}</div>
                      <div className="text-xs text-[#8B99B0]">{c.designation || '—'}</div>
                    </td>
                    <td className="px-4 py-2.5 text-[#5B6B84]">{c.district || '—'}</td>
