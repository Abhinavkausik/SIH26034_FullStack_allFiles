...
import { PriorityBadge } from '../common/StatusIndicators';
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-xl bg-[#EEF2F8] border border-[#D6DEEA]">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#5B6B84] font-mono flex items-center gap-2 flex-wrap">
                      <span>
                        Compliance Score: <strong>{scanResult.complianceScore ?? '—'}/100</strong> • Brand: {scanResult.brand}
                      </span>
                      {scanResult.priority && (
                        <PriorityBadge priority={scanResult.priority} title={scanResult.priorityReason || undefined} />
                      )}
                    </p>
                  </div>
                </div>
